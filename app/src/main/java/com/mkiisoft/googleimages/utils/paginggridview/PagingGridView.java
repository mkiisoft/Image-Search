...
import com.mkiisoft.googleimages.utils.paginggridview.FooterViewGridAdapter;
import com.mkiisoft.googleimages.utils.paginggridview.LoadingView;
import com.mkiisoft.googleimages.utils.paginggridview.PagingBaseAdapter;

import java.util.List;


public class PagingGridView extends com.mkiisoft.googleimages.utils.paginggridview.HeaderGridView {
	...
	private com.mkiisoft.googleimages.utils.paginggridview.LoadingView loadinView;
	...
	public void onFinishLoading(boolean hasMoreItems, List<? extends Object> newItems) {
		...
		if(newItems != null && newItems.size() > 0) {
			...
			if(adapter instanceof com.mkiisoft.googleimages.utils.paginggridview.PagingBaseAdapter) {
