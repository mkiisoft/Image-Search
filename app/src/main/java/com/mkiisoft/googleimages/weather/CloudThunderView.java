package com.mkiisoft.googleimages.weather;
...
public class CloudThunderView extends SkyconView {
    ...
    private void init() {
        ...
        paintCloud.setShadowLayer(0, 0, 0, Color.WHITE);
        ...
        paintThunder.setShadowLayer(0, 0, 0, Color.WHITE);
    ...
    public void onDraw(Canvas canvas) {
        ...
        paintCloud.setColor(Color.TRANSPARENT);
